...
$erreurs = "";
$db = new PDO('mysql:host=localhost;dbname=todobd;charset=utf8', 'root', ''); //connexion a la base de donné
...
if(isset($_GET['modifier_tache'])) {
    ...
    $db->exec("UPDATE FROM tache WHERE tache=$tache");
}

?>

<link rel="stylesheet" href="index.css" />   <!-- Lié le Css a la page -->
...
<table class="taches">
    ...
    while ($taches = $reponse->fetch()) { // On initialise une boucle
        ...
        <tr>
            ...
            <td><input id="inserer" type="text" name="modifier_tache"/><a class="modif" href="index.php?modifier_tache=<?php echo $taches['id'] ?>"> Modifier</a></td>
        </tr>
        <?php
    }
